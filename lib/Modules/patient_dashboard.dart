      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: MediaQuery.of(context).size.height * 0.01), //15
            ...
            SizedBox(
                height: MediaQuery.of(context).size.height * 0.03), //height: 15
            ...
            SizedBox(
                height: MediaQuery.of(context).size.height * 0.01), //height: 15
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: SizedBox(
                        height: screenHeight * 0.432, // Adjusted height
                        width: screenWidth,
                        child: CustomPaint(
      ...
      child: Column(
        children: [
          ...
          Text(
            '70%',
            style: TextStyle(
                fontSize: screenWidth * 0.065, fontWeight: FontWeight.bold),
          ),
          SizedBox(height: screenHeight * 0.01),
          Container(
            padding: EdgeInsets.symmetric(
