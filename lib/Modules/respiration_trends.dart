...
void main() {
  runApp(RespirationChartApp());
}

class RespirationChartApp extends StatelessWidget {
  const RespirationChartApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: RespirationChartScreen(),
    );
  }
}

class RespirationChartScreen extends StatefulWidget {
  const RespirationChartScreen({super.key});

  @override
  _RespirationChartScreenState createState() => _RespirationChartScreenState();
}

class _RespirationChartScreenState extends State<RespirationChartScreen> {
